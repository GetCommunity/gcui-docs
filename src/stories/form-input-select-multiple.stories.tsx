import type { SelectMultipleInputProps } from '@getcommunity/gcui/form-input';
import { SelectMultipleInput } from '@getcommunity/gcui/form-input';
...
type Story = StoryObj<SelectMultipleInputProps<ClientRead>>;

export const Default: Story = { args: {} };

// TODO: add more stories for different variations of select multiple inputs

export default {
  title: 'GCui/FormInput/SelectMultipleInput',
  tags: ['autodocs'],
  // @ts-ignore-next-line
...
} as Meta<ComponentProps<typeof SelectMultipleInput>>;
