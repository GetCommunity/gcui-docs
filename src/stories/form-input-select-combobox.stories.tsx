import type { ComboboxInputProps } from '@getcommunity/gcui/form-input';
import { ComboboxInput } from '@getcommunity/gcui/form-input';
...
type Story = StoryObj<ComboboxInputProps<ClientRead>>;

export const Default: Story = { args: {} };

// TODO: add more stories for different variations of combobox inputs

export default {
  title: 'GCui/FormInput/ComboBoxInput',
  tags: ['autodocs'],
  // @ts-ignore-next-line
  render: ({ label, required, numberOfClients }) => {
    ...
    return (
      <ComboboxInput<ClientRead>
        ...
        error={
          required && comboboxClient() === null ? 'This field is required.' : undefined
        }
      />
    );
  },
...
} as Meta<ComponentProps<typeof ComboboxInput>>;
